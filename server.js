...
async function dbConnect() {
  ...
  if (!cached.promise) {
    ...
    cached.promise = mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/bovinesense', opts).then((mongoose) => {
...
// Middleware to ensure DB connection before hitting routes
